...
## Project Structure
    ...
    ├── testapiautosettings_89798  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_89798`
...
2. Clone this repo and `cd testapiautosettings_89798`
